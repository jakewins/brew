...
public class ResourcesTest  {
    ...
    private static final String ONE_FILE = "one.css";
    private static final String ONE_IDENTIFIER = "color: #4d926f";
    private static final String TWO_FILE = "two.css";
    private static final String TWO_IDENTIFIER = "ul.menu {\n" +
            "  background: #ccc;\n" +
